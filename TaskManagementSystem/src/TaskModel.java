...
public class TaskModel implements ModelInterface{
    ...
    public ResultSet select(Map<String, Object> whereParameters) throws Exception {
        ...
        sql.append(" SELECT ");
        sql.append(" EmployeeID,T.TaskID,W.SubTaskID,Description,Status,Priority");
        sql.append(" FROM SubTask as T INNER JOIN WorksOn as W");
        sql.append(" ON T.TaskID = W.TaskID AND T.SubTaskID = W.SubTaskID");
